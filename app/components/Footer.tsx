...
const Footer = () => {
  return (
    <footer className="bg-dark relative z-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6">
              The revolutionary AI that legally searches the entire internet—including public, deep, and dark web—to deliver unparalleled insights.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} OmniQuery AI. All rights reserved.
          </p>
